...
export const Fields = deepFreeze({
	createRoom: [
		...
		{ id: "roundLimit", type: "int", label: "Rounds", min: 1, max: 10, default: 8 },
		{ id: "clientLimit", type: "int", label: "Player Limit", min: 2, max: 8, default: 6 },
		{ id: "ownerName", type: "string", label: "Your Name", min: 1, max: 16, default: "" },
	],

	joinRoom: [
		{ id: "roomID", type: "STRING", label: "Room Code", min: 8, max: 8, default: "", password: true },
