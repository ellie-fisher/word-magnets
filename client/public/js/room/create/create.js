...
import { $singleton, $replace, $getAll, $center, createState } from "../../framework.js";
import { RoomStates, RoomData, RoomWords, getRoomWord, clearRoomSentences } from "../state.js";
 ...
 */
export const Create = $singleton({
	onMount() {
		switch (RoomData.state.get()) {
